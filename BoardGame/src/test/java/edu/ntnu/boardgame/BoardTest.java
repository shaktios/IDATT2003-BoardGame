...
public class BoardTest {
    ...
    void testInvalidBoardSize() {
        assertThrows(IllegalArgumentException.class, () -> new Board(0), "Bør kaste exception for ugyldig brettstørrelse.");
        assertThrows(IllegalArgumentException.class, () -> new Board(-5), "Bør kaste exception for negativ brettstørrelse.");
    }
