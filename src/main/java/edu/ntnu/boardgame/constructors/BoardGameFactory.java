...
public class BoardGameFactory {
  ...
  /**
   * Creates the classic ladder game.
   *
   * @return the classic ladder game view
   */
  ...
  /**
   * Creates the Mini version of laddergame.
   *
   * @return the smaller version of the ladder game
   */
  ...
  /**
   * Creates game from JSON-file.
   *
   * @param path is the source path of the JSON file
   * @return it returns the game created from the JSON file
   * @throws IOException a validator
   * @throws InvalidBoardFileException another validator
   */
  // 3. Les spillbrett fra JSON-fil
  public static Boardgame createGameFromFile(Path path) throws IOException,
