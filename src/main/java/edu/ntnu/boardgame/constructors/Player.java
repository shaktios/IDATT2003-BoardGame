...
/**
 * A constructor class representing a Player for the games.
 * The class has methods gathering information about
 * the player and defines their starting move
 *
 */
public class Player {
  private String name; 
  ...
  /**
    ...
    *if the startTile is null or the age is negative
    * 
  */
